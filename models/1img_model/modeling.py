...
class LXRTEncoder(nn.Module):
    ...
    def forward(self, lang_feats, lang_attention_mask,
        ...
        with open('/content/drive/My Drive/att_scores_out/sent_feats.txt', 'a+') as f:
        ...
        np.save('/content/drive/My Drive/att_scores_out/'+str(batch)+'.npy', attention_scores_dict)
        batch += 1
        attention_scores_dict = {'lang': [], 'vision': [], 'cross': []}
