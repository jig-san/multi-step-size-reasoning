...
class BertLayer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, modal='lang'):
        global out_attentions
        attention_output = self.attention(hidden_states, attention_mask)
        #out_attentions['self_'+modal].append(attention_output.tolist())

        intermediate_output = self.intermediate(attention_output)
        layer_output = self.output(intermediate_output, attention_output)
        out_attentions['self_' + modal].append(layer_output.tolist())
        return layer_output
...
class LXRTXLayer(nn.Module):
    ...
    def forward(self, lang_feats, lang_attention_mask,
        ...
        # out_attentions['cross_lang'].append(lang_att_output.tolist())
        # out_attentions['cross_vis'].append(visn_att_output.tolist())
        ...
        out_attentions['cross_lang'].append(lang_output.tolist())
        out_attentions['cross_vis'].append(visn_output.tolist())
...
class LXRTEncoder(nn.Module):
    ...
    def forward(self, lang_feats, lang_attention_mask,
        ...
        for layer_module in self.r_layers:
            visn_feats = layer_module(visn_feats, visn_attention_mask, 'vis')
        ...
        out_final.append(out_attentions)
...
class LXRTModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
        ...
        print(len(embedding_output.tolist()))
