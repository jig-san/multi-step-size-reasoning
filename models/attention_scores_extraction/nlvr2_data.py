...
class NLVR2TorchDataset(Dataset):
    def __init__(self, dataset: NLVR2Dataset):
        ...
        if 'test' in dataset.name:
            img_data.extend(load_obj_tsv('data/nlvr2_imgfeat/test_obj36.tsv', topk=32))
        self.imgid2img = {}
        ...
        for datum in self.raw_dataset.data:
            if datum['img0'] in self.imgid2img and datum['img1'] in self.imgid2img and datum['img2'] in self.imgid2img:
